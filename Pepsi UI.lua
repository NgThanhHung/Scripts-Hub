...
local library = {
	...
	colors = {
		...
		outerBorder = Color3.fromRGB(50, 50, 50),
		innerBorder = Color3.fromRGB(255, 255, 255),
		topGradient = Color3.fromRGB(45, 45, 45),
		...
		unselectedOption = Color3.fromRGB(25, 25, 25),
...
function library:CreateWindow(options, ...)
	...
	main.Size = UDim2.fromOffset(550, 650)
